...
@login_required # to be login before use this view
def new_topic(request, board_id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            topic2 = form.save(commit=False)
            topic2.board = board
            topic2.created_by = request.user
            topic2.save()
            ...
            return redirect('boards_topic', board_id=board.pk)
    else:
        form = NewTopicForm()
